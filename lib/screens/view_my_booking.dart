...
class ConfirmAndPayScreen2 extends StatefulWidget {
  @override
  _ConfirmAndPayScreenState createState() => _ConfirmAndPayScreenState();
}

class _ConfirmAndPayScreenState extends State<ConfirmAndPayScreen2> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                child: Text('View receipt', style: TextStyle(fontSize: 18)),
